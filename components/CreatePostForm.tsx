...
export default function CreatePostForm() {
  ...
  const handleImageUpdload = (result: CldUploadWidgetResults) => {
    ...
    <div>
      ...
      <form className="flex flex-col gap-2" onSubmit={handleSumbit}>
        ...
        <CldUploadButton
          ...
          grid place-items-center bg-slate-100 rounded-md 
          relative ${imageUrl && "pointer-events-none"}`}
          onUpload={handleImageUpdload}
        >
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
